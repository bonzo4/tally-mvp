...
function useTickers(supabase: SupabaseClient<Database>, setLoading: React.Dispatch<React.SetStateAction<boolean>>) {
...
export default function Tickers() {
  ...
  return (
    <motion.div 
      transition={}
      className="w-full flex justify-between items-center bg-purple-50 py-2 px-2 lg:px-5 space-x-3 overflow-auto"
    >
    {
