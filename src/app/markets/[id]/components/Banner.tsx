...
function BannerTitle(props: { status: string }) {
  switch (props.status) {
    case "fairLaunch":
      return (
        <div className="">
          <h1 className="text-3xl md:text-5xl text-green-500 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] font-bold text-center lg:text-left">
            TOTAL POT: $0.00
          </h1>
          <h1 className="text-3xl md:text-5xl text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] font-bold text-center lg:text-left">
    ...
    case "frozen":
      return (
        <div>
          <div className="lg:mb-5 flex flex-col lg:flex-row items-center">
            <div className="mr-5 mb-3 lg:mb-0">
              <h1 className="text-3xl md:text-5xl text-blue-400 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] font-bold text-center lg:text-left">
                LEADING: NO
              </h1>
            </div>
          </div>
